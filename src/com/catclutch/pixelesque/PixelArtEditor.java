...
import com.catclutch.pixelesque.shapes.Bucket;
import com.catclutch.pixelesque.shapes.Circle;
import com.catclutch.pixelesque.shapes.Line;
import com.catclutch.pixelesque.shapes.Pen;
import com.catclutch.pixelesque.shapes.Pencil;
import com.catclutch.pixelesque.shapes.Rectangle;
import com.catclutch.pixelesque.shapes.Shape;
import com.catclutch.pixelesque.shapes.ShapeEditor.ShapeFactory;
...
public class PixelArtEditor extends PApplet implements TouchListener, Drawer {
	...
	public void onCreate(final Bundle savedinstance) {
		...
		bbbar = (RelativeLayout)getLayoutInflater().inflate(com.catclutch.pixelesque.R.layout.buttonbar, null);
		this.setContentView(bbbar, new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
		buttonbar = (PixelArtStateView)bbbar.findViewById(com.catclutch.pixelesque.R.id.buttonbarz);
		ViewGroup g = (ViewGroup)bbbar.findViewById(com.catclutch.pixelesque.R.id.surfaceholder);
	...
	void actualsetup() {
	    ...
	    buttonbar.setParent(findViewById(com.catclutch.pixelesque.R.id.layout));
...
//		}
		...
		art = PixelArt.makeFromShortside(32, 16, 16);
		art.setDrawer(this);
		checkBounds();
	...
	class OpenArtTask extends AsyncTask<String, Void, PixelArt> {
		...
		protected void onPreExecute() {
			String title = getResources().getString(com.catclutch.pixelesque.R.string.loading_title);
			String text = getResources().getString(com.catclutch.pixelesque.R.string.loading_text);
		...
		protected PixelArt doInBackground(String... params) {
			...
			try {
				...
				runOnUiThread(new Runnable() { public void run() {
					Toast.makeText(PixelArtEditor.this, com.catclutch.pixelesque.R.string.open_extras_failed, Toast.LENGTH_SHORT).show();
				}});
			}
			return art;
		}		
		...
		protected void onPostExecute(PixelArt result) {
			...
			if (result != null) {
				...
				Toast.makeText(PixelArtEditor.this, com.catclutch.pixelesque.R.string.open_failed, Toast.LENGTH_SHORT).show();
			d.dismiss();
			scheduleRedraw();
		}	
	}
...
//		art.flipColor(x, y);
	...
	public class ChangeName implements Runnable {
		public void run() {
			TextView view = (TextView)findViewById(com.catclutch.pixelesque.R.id.picturename);
			if (art != null && art.name != null)  {
				if (view != null) view.setText(art.name);
				//setTitle("Pixelesque - "+art.name);
				setTitle(art.name);
			} else {
				String title = getResources().getString(com.catclutch.pixelesque.R.string.new_art_title);
	...
	public boolean onCreateOptionsMenu(final Menu menu) {
	    ...
	    inflater.inflate(com.catclutch.pixelesque.R.menu.mainmenu, menu);
	    return true;
	}
	...
	public boolean onMenuItemSelected(final int featureId, final MenuItem item) {
	    ...
	    switch (item.getItemId()) {
		    ...
		    case com.catclutch.pixelesque.R.id.main_menu_pixelwrite:
		        save_pixel();
		        return true; 
		    case com.catclutch.pixelesque.R.id.main_menu_save:
		        save();
		        return true;
		    case com.catclutch.pixelesque.R.id.main_menu_save_as:
		        showPrompt = false;
		    	saveas(showPrompt);
		        return true;
		    case com.catclutch.pixelesque.R.id.main_menu_export:
		        export();
		        return true;
		    case com.catclutch.pixelesque.R.id.main_menu_share:
		        share();
		        return true;
		    case com.catclutch.pixelesque.R.id.main_menu_open:
		        load();
		        return true;
		    case com.catclutch.pixelesque.R.id.main_menu_new:
		        shownew();
		        return true;
		    case com.catclutch.pixelesque.R.id.main_menu_clear:
		        clear();
		        return true;
		    case com.catclutch.pixelesque.R.id.main_menu_preview:
		        togglePreview();
		        return true;
		    case com.catclutch.pixelesque.R.id.main_menu_gridtoggle:
		        toggleGrid();
		        return true;
//		    case com.catclutch.pixelesque.R.id.main_menu_background:
//		        importBackground();
//		        return true;
		    case com.catclutch.pixelesque.R.id.main_menu_about:
		    	about();
		    	return true;
...
//		            Bitmap yourSelectedImage = BitmapFactory.decodeFile(filePath);
	        		...
	        		Toast.makeText(this, com.catclutch.pixelesque.R.string.custombg_failed, Toast.LENGTH_LONG).show();
	        	}
	        }
	...
	public void save_pixel() {
		if (art.name == null) {
			...
			showToast("Save and then tap record button again to send to your CAT Clutch");
		}
		else
			save_pixel(art.name);
	}
